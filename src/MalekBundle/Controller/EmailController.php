...
class EmailController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $emails = $em->getRepository('MalekBundle:Email')->findAll();
    ...
    {
        $email = new Email();
        $form = $this->createForm('MalekBundle\Form\EmailType', $email);
    ...
    {
        $deleteForm = $this->createDeleteForm($email);
        $editForm = $this->createForm('MalekBundle\Form\EmailType', $email);
