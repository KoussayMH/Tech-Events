...
use DorraBundle\Entity\Produit;
...
class ProduitController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $produits = $em->getRepository('DorraBundle:Produit')->findAll();
    ...
    {
        $produit = new Produit();
        $form = $this->createForm('DorraBundle\Form\ProduitType', $produit);
    ...
    {
        $deleteForm = $this->createDeleteForm($produit);
        $editForm = $this->createForm('DorraBundle\Form\ProduitType', $produit);
    ...
    public function afficherProduitAction()
    {
        ...
        return $this->render('@Dorra/ProduitAdmin.html.twig', array('liste'=>$liste));
